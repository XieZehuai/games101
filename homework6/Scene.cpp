        ...
        switch (m->getType())
        {
            ...
            default: {
                ...
                Vector3f shadowPointOrig =
                    (dotProduct(ray.direction, N) < 0) ? hitPoint + N * EPSILON : hitPoint - N * EPSILON;
                // [comment]
                ...
                for (uint32_t i = 0; i < get_lights().size(); ++i)
                {
                    ...
                    else
                    {
                        ...
                        // is the point in shadow, and is the nearest occluding object closer to the object than the
                        // light itself?
                        ...
                        specularColor +=
                            powf(std::max(0.f, -dotProduct(reflectionDirection, ray.direction)), m->specularExponent) *
