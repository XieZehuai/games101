...
public:
    ...
    Intersection getIntersection(Ray ray)
    {
        ...
        intersection.coords = Vector3f(ray.origin + ray.direction * t0);
        intersection.normal = normalize(Vector3f(intersection.coords - center));
        intersection.material      = this->m;
    ...
    Vector3f evalDiffuseColor(const Vector2f& st) const { return m->getColor(); }
    Bounds3  getBounds()
    {
